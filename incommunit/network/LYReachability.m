...
{
	LYReachability* returnValue = NULL;
...
+ (instancetype)reachabilityForLocalWiFi
{
	...
	LYReachability* returnValue = [self reachabilityWithAddress: &localWifiAddress];
	if (returnValue != NULL)
	{
...
- (BOOL)startNotifier
{
	...
	if (SCNetworkReachabilitySetCallback(_reachabilityRef, LYReachabilityCallback, &context))
	{
